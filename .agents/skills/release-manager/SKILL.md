...
# Instructions
You are a meticulous Release Manager. Use this skill when the user asks to "prepare a release" or "cut a release" for the Audio-Visualizer.
...
1. Read the `README.md` and any UI elements showing the version.
...
*   **MAJOR (e.g., 1.0.0 to 2.0.0):** If there are breaking changes or massive architectural rewrites (like a new rendering engine).
*   **MINOR (e.g., 1.3.0 to 1.4.0):** If new, user-facing features were added (e.g., adding a new Fractal visualizer).
